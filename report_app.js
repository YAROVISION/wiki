...
const COLUMNS_DATA = [
  ...
  },
  {
    ...
    "instruction": "Вкажіть загальну кількість (ціле число) за звітний період. Загальна кількість завізованих наказів (ціле число) за звітний період. До цих наказів відносяться всі види наказів, а саме: накази з основної роботи, з адміністративно-господарської діяльності, з оплати праці та фінансової роботи, кадрові (призначення на посаду, звільнення, переміщення по посадах, відпустки, про вихідні дні, на відрядження). Ця кількість повинна співпадати із показниками стовпчиків K, L звіту про виконання АП (АП1)."
  },
  {
    "col_index": 29,
    "col_letter": "РР_29",
  ...
  },
  {
    ...
    "instruction": "Вкажіть загальну кількість (ціле число) за звітний період. До таких пакетів документів відносяться документи саме кандидата на посаду. Документи які готуються для переведення з посади на посаду сюди не включаються."
  },
  {
    "col_index": 59,
    "col_letter": "РР_59",
    ...
    "instruction": "Вкажіть загальну кількість (ціле число) за звітний період. У цій графі треба вказувати договори, які пройшли публічні закупівлі (тендери)."
  },
  {
    "col_index": 60,
    "col_letter": "РР_60",
